...
@Schema(description = "The essence of the sell request")
public record CompletedCryptoSellRequest(
        Long userId,
        ...
        @Schema(description = "Indicates the price of one cryptocurrency unit that we want to sell")
